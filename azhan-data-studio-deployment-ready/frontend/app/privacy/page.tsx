...
export default function PrivacyPage() {
  return <main className="legalPage">
    ...
    <article className="legalArticle">
      ...
      <section><h2>Cookies and analytics</h2><p>Azhan Data Studio uses Google Analytics 4 (GA4) to understand aggregate website traffic and product usage, such as page views, feature navigation, sample-data use, analysis starts and optional support-link clicks. GA4 may use cookies and process routine device, browser and network information under Google's own terms. Azhan Data Studio does not intentionally send uploaded dataset contents, file names or analysis values to Google Analytics.</p><p>Analytics is used to improve the public product and understand which workflows are useful. It is not used by Azhan Data Studio for personalised advertising.</p></section>

    ...
    <main>
      ...
      <nav className="studioModeBar" aria-label="Choose analysis mode">
        <div className="studioModeInner">
          ...
          <a className="studioModeTab active" href="/compare"><span className="studioModeIcon">↔</span><span><strong>Compare Datasets</strong><small>Find changes between two versions</small></span><em>NEW</em></a>
        </div>
      </nav>
